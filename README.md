# 🌬️ Air Quality Index (AQI) Forecasting using XGBoost
...
* **Analyze:** Understand which pollutants contribute most to air quality degradation.
...
* **Overall Accuracy Grade:** ~82.8%

### 1. Model Output & Forecast
